...
MOCK["data/mock_data.py<br/>Mock 数据"]
...
- [tools/order_tools.py:12-50](file://tools/order_tools.py#L12-L50)
- [tools/product_tools.py:7-78](file://tools/product_tools.py#L7-L78)
...
- Mock 数据层：演示阶段的硬编码字典，便于快速替换为真实数据库。
